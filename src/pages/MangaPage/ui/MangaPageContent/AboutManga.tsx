...
import { AboutMangaLayout } from './AboutMangaLayout';
...
import { CategoryCollapsedList, useCategoriesList } from '@/entities/GenresAndTagsList';
...
export const AboutManga: FC<AboutMangaProps> = (props) => {
    ...
    return (
        ...
        >
            ...
            <RelatedMangaSlider
                mangaId={mangaId}
                className={cn(isMobile ? 'w-[100vw]' : 'w-[calc(100vw-306px)]  max-w-[925px]')}
                heading={
